...
const Footer = () => {
  return (
    ...
    <div className="text-gray-300 bg-gray-900 flex flex-col items-center gap-8 px-8 py-12" id="footer">
          ...
          <ul className="space-y-5">
            <li className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-lg text-white"> <span className="font-medium text-orange-500">Phone: </span> 070012 92498</p>
              </div>
            </li>
            <li className="flex items-start gap-4">
              <div className="w-8 h-8 rounded-full bg-orange-500/20 flex items-center justify-center">
              ...
              <div>
                ...
                <a href="mailto:galaxy@multygym.org" className="text-lg text-white hover:text-orange-400 transition-colors"> <span className="font-medium text-orange-500">Email: </span>
                galaxy@multygym.org
                </a>
              </div>
            </li>
            <li className="flex items-start gap-4">
              ...
              <div>
                ...
                Amartala, Cooch Behar, West Bengal -736101
                </p>
              </div>
            </li>
            <li className="mt-4">
              ...
              <iframe 
                src= "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3575.8742046755838!2d89.4488833754195!3d26.330572576998986!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39e2fe99466486b3%3A0x3f806fa7a1c2015a!2sGalaxy%20Multi-gym!5e0!3m2!1sen!2sin!4v1740631786030!5m2!1sen!2sin"
      ...
      Copyright © 2025 Galaxy-Multi-Gym Fitness Gym - All Rights Reserved | A Galaxy-Multi-Gym® Company!. Crafted with ❤️ in India
      </p>
    </div>
    </>
  );
